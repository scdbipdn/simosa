...
<aside class="main-sidebar" style='background-color:navy;'>
    <!-- sidebar: style can be found in sidebar.less -->
    <section class="sidebar" style="background-color:navy;">
        <!-- Sidebar user panel -->
        <div class="user-panel">
            ...
            <div class="pull-left info" style="margin-top: 5px; color:white;">
                <p><?php echo $d->nama; ?></p>
                <p><?= $d->level; ?></p>
                <a href="#"><i class="fa fa-circle text-success"></i> <font color='white'>Online</font></a>
            </div>
            <br />
            <br />
            <br />
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <?php if ($this->session->userdata('level') == 'Petugas') { ?>
                ...
                <li class="header" style='background-color:black; color:crimson;'>MAIN NAVIGATION</li>
            ...
            <?php if ($this->session->userdata('level') == 'Praja') { ?>
                ...
                <li class="<?php if ($this->uri->uri_string() == 'transaksi/kembali') {
                    ...
                    <a href="<?php echo base_url("transaksi/kembali"); ?>" class="cursor">
                        <i class="fa fa-upload"></i> <span>Data Essay</span>
                    </a>
                </li>
                <li class="<?php if ($this->uri->uri_string() == 'data') {
                                echo 'active';
