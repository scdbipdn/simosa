 ...
 <div class="container-fluid bg-primary text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5 px-lg-5">
        <div class="row g-5">
            ...
            <div class="col-md-4">
                <h5 class="text-white mb-4">Support By</h5>
                <img src="<?= base_url('assets_style/assets_depan/img/logo.png') ?>" class="img-fluid rounded-top" alt="">
            </div>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    ...
                    Created By <a class="border-bottom" href="#">Lab. Bahasa IPDN</a>
