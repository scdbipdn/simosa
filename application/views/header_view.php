...
<head>
  ...
  <script src="<?php echo base_url(); ?>node_modules/ckeditor/ckeditor.js"></script>
  <!--penambahan-->
...
<body class="hold-transition skin-blue-light sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="<?php echo base_url('/dashboard'); ?>" class="logo" style='background-color:crimson;'>
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini">

        </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="<?= base_url('assets_style/image/logo/logo-ipdn.png') ?>" width="15%" alt=""> &nbsp; <b>SIMOSA IPDN</b></span>
      </a>
      <!-- Header Navbar: style can be found in header.less -->
      <nav class="navbar navbar-static-top" style='background-color:crimson;'>
